#!/usr/bin/env python3
"""
Compare Screen - Create Save Chart Button

Creates and styles the save chart image button.
...
def create_save_chart_button(self):
    """Create and style the save chart image button
