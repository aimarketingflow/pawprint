#!/usr/bin/env python3
"""
Compare Screen - Export Data Button

Creates and styles the data export button.
...
def create_export_data_button(self):
    """Create and style the data export button
    
    Returns:
        QPushButton: Styled export data button
    """
    try:
        # Create export button with dark theme and teal styling
        ...
        logger.error(f"Error creating export data button: {str(e)}")
